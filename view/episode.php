				...
				foreach ($comments as $comment) {
					...
					<tr id="commentaires">
						<td>
							...
							<p><a href="<?= HOST; ?>/rudeComment/<?=strip_tags($comment->getId()); ?>#commentaires"><input type="button" value="(Dé)Signaler le commentaire" class="btn btn-outline-secondary" /></a></p>
						</td>
					</tr>
					<?php
				}
